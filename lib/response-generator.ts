 ...
 */
export function linkifyResponse(
  responseText: string,
  links: SiteLink[],
): string {
...
export async function generateResponse(
  ...
  try {
    console.log(
      "[RESPONSE GEN] Generating response for query:",
      query.substring(0, 50),
    );
    console.log(
      "[RESPONSE GEN] Session history length:",
      sessionHistory.length,
    );
    console.log(
      "[RESPONSE GEN] Session history preview:",
      sessionHistory.substring(0, 200),
    );
...
`;
    ...
    console.log(
      "[RESPONSE GEN] Generated response text:",
